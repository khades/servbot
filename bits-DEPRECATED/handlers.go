...
import (
	...
	// mux.HandleFunc(pat.Search("/api/channel/:channel/bits"), withMod(bits))
	// mux.HandleFunc(pat.Search("/api/channel/:channel/bits/search/:search"), withMod(bitsSearch))
	// mux.HandleFunc(pat.Search("/api/channel/:channel/bits/:userID"), withMod(userbits))
