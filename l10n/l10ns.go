...
func HumanizeDuration(duration time.Duration, lang string) string {
	return  HumanizeDurationFull(duration, lang, false)
}

//HumanizeDurationFull converts time.Duration to human-readable string with optional seconds
func HumanizeDurationFull(duration time.Duration, lang string, withSeconds bool) string {
